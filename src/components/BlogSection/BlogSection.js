                            ...
                            <div className="blog_post_block">
                                <div className="blog_post_image">
                                    {/* <Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`} className="image_wrap">
                                     ...
                                     <Link onClick={ClickHandler} to={`/`} className="image_wrap">
                                        <img src={blog.screens} alt="" />
                                    </Link>
                                </div>
                                <div className="blog_post_content">
                                    <div className="post_meta_wrap">
                                        <ul className="category_btns_group unordered_list">
                                            ...
                                            <li><Link onClick={ClickHandler} to={`/`}>{blog.thumb}</Link></li>
                                        </ul>
                                        <ul className="post_meta unordered_list">
                                            ...
                                            <li>
                                                ...
                                                <Link onClick={ClickHandler} to={`/`}><i className="fa-regular fa-comment-lines"></i> {blog.comment}</Link>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <Link onClick={ClickHandler} to={`/`} className="btn_unfill">
                                        <span className="btn_icon">
                                            <i className="fa-solid fa-arrow-up-right"></i>
                                        </span>
                                        <span className="btn_label">Read More</span>
