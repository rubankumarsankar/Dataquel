                    ...
                    <div className="row align-items-end">
                        <div className="col-lg-7">
                            ...
                            <h2 className="heading_text">
                                A Glimpse into Our Most Impactful Work 
                            </h2>
                            <p className="heading_description mb-0">
                                Showcasing recent success stories where strategy met execution and delivered measurable results. 
                            </p>
                        </div>
                        ...
                        <SwiperSlide key={prj}>
                            <div className="portfolio_block" >
                                <div className="portfolio_image">
                                    <Link onClick={ClickHandler} className="portfolio_image_wrap bg-light" to={`/`}>
                                ...
                                <div className="portfolio_content">
                                    ...
                                    <ul className="category_list unordered_list">
                                        <li><Link onClick={ClickHandler} to={`/`}>{project.sub}</Link></li>
                                    </ul>
