...
const MicrosoftAdoptionPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Upgrade Your Operations With Managed Microsoft Adoption and Change Management Services"
          description="Seamlessly elevate your operations with expertly executed Microsoft 385 integrations that do the hard work for you."
...
export default MicrosoftAdoptionPage;
