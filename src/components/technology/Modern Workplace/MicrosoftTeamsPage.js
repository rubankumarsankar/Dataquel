...
const MicrosoftTeamsPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Embrace Collaboration and Boost Productivity With Microsoft Teams"
          description="Take your team’s productivity to new heights with Microsoft Team’s simplified approach to collaboration, inspiration, and efficiency."
