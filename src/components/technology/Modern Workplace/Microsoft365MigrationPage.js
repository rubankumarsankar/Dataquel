...
const Microsoft365MigrationPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Take The Stress Out Of Microsoft 365 Migrations"
          description="Streamline the move to Microsoft 365 with hands-on support from our technology consulting team."
...
export default Microsoft365MigrationPage;
