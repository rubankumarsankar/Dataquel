...
const MicrosoftOfficePage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Enhance Your Security With Microsoft 365 Compliance Services"
          description="Protect your organization’s digital assets with automated solutions for Microsoft 365 security and compliance strategies."
