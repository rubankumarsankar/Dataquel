...
const CloudSolutionsPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Serve More Customers With Cloud-Based Solutions"
          description="Create seamless software delivery processes with secure cloud-based solutions created by our team of technology consultants."
