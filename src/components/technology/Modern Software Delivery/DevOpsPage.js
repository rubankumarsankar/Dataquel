  ...
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="DevOps"
          subtitle="Create Dynamic Results With Our DevOps Solutions"
          description="Produce more high-quality work for your customers with DataQuel’s systemic approach to efficient DevOps integration."
