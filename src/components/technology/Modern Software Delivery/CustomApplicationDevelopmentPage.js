...
const CustomApplicationDevelopmentPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Expert Application Development Solutions"
          description="From optimizing your operations to providing more value to customers, we provide custom application development tailored to your needs."
...
export default CustomApplicationDevelopmentPage;
