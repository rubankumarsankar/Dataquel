...
const SoftwareQualityPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Software Quality & Assurance Testing You Can Trust"
          description="Get your software products ready to launch with expert quality and assurance testing to identify weak points and improve customer satisfaction."
...
export default SoftwareQualityPage;
