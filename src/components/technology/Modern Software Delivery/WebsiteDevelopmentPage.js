...
const WebsiteDevelopmentPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Build Your Dream Website With DataQuel"
          description="Take the hassle out of building and maintaining a high-performing WordPress website with custom-tailored solutions from our experts."
