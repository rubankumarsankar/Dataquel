...
const OutsourcingITServicesPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Grow Your IT Team With Virtual Efficiency"
          description="Fill the gaps in your IT staff with reliable, qualified virtual teams to handle everything from tedious tasks to large-scale projects."
...
export default OutsourcingITServicesPage;
