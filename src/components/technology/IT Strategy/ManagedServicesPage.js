...
const ManagedServicesPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Eliminate Tedious Tasks With Managed IT Support"
          description="Take the stress off your in-house IT team with expertly managed IT services for remote monitoring, cloud management, and more."
