  ...
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="IT Strategy"
          subtitle="Develop Next-Level IT Strategies For Faster, More Efficient Operations"
          description="Enlist the expert insight of our technology consulting professionals to take your business’s IT strategies to the next level."
