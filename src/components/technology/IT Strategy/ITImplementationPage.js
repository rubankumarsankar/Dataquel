...
const ITImplementationPage = (props) => {
  return (
    <Fragment>
      {/* <Header /> */}
      <MainNavbar />
      ...
      >
        <PagesTitleNew
          ...
          subtitle="Seamless IT Implementation Solutions"
          description="Streamline your IT implementation strategies with the help of an experienced technology consulting company."
...
export default ITImplementationPage;
