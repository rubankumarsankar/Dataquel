    ...
    <Fragment>
      ...
      >
        <PagesTitleNew
          ...
          subtitle="."
          description="Customer relationships are the very heart of your operation. At DataQuel, we strive to help our clients improve their customer service capabilities with proven methods for creating high-quality Customer Contact Centers (CCC). Based on the framework of SO 18295, we build dynamic customer support systems that fuel sustainable growth."
...
export default ISO1829512017Page;
