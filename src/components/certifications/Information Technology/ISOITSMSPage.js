...
const ISOITSMSPage = (props) => {
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="ISO 20000-1:2018 Information Technology Services Management System"
          subtitle="."
          description="Robust IT strategies start with a solid Information Technology Services Management System (SMS). As a leading IT consulting firm, DataQuel helps our clients achieve more stability in their processes with ISO 2000 ITSMS certification, a globally recognized gold standard for technology service providers."
