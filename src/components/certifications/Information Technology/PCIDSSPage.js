    ...
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="PCI DSS"
          subtitle="."
          description="PCI DSS, or Payment Card Industry Data Security Standard certification, is a requirement for businesses that store and maintain cardholder data. From eCommerce brands to subscription-based services, DataQuel is here to help you maintain PCI DSS compliance and streamline your payment processing methods."
