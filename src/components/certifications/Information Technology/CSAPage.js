    ...
    <Fragment>
      ...
      >
        <PagesTitleNew
          ...
          subtitle="."
          description="Consumers choose cloud service providers based on their ability to provide a safe, secure platform for storing and exchanging data. As a certified platform by the Cloud Service Alliance (CSA), cloud providers can increase the trust of their consumers and join a globally recognized network of reliable providers."
