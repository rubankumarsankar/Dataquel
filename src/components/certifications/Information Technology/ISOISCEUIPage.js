...
const ISOISCEUIPage = (props) => {
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="ISO 27019:2019 Information Security Control for Energy Utility Industry"
          subtitle="."
          description="In the energy sector, implementing reliable security controls can be complicated. ISO 27019 Information Security Controls for Energy Utility Industry Certification strives to simplify this process by providing a clear framework for building and maintaining reliable process control systems (PCS) throughout your operation."
