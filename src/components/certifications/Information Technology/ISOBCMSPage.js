...
const ISOBCMSPage = (props) => {
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="ISO 22301:2019 – Business Continuity Management System (BCMS)"
          subtitle="."
          description="In today’s ever-evolving marketplace, the possibility of disruptions is higher than ever. DataQuel is here to help our clients turn disruptions into opportunities with advanced ISO 22301 Business Continuity Management System (BCMS) certification. With our help, you can avoid pitfalls and create dynamic results."
