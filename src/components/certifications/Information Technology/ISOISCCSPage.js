...
const ISOISCCSPage = (props) => {
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="ISO 27017:2015 Information Security Control for Cloud Services"
          subtitle="."
          description="Cloud service providers face some of today’s most complex security challenges, making the need for robust security controls critical. ISO 27017 Information Security Control for Cloud Services (ISCCS) seeks to combat these issues with a defined process for securing client data and providing superior services."
