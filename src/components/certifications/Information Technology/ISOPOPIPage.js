...
const ISOPOPIPage = (props) => {
  return (
    <Fragment>
      ...
      >
        <PagesTitleNew
          title="ISO 27018:2019 Protection of Personally Identifiable"
          subtitle="."
          description="Today, data breaches pose a significant risk for consumers and businesses alike. ISO 27018 Protection of Personally Identifiable Information (PPII) certification helps organizations mitigate these risks with a proven framework for protecting sensitive information about your customers on public cloud services."
